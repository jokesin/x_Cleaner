...
is
   ...
   procedure HMG_IS5_Ext_Proc with Inline
   is
   begin
      -- Set algorithm name
      Drv_List.Set_Algorithm_Name(Data.Drive_Index,"HMG IS5 (Extended)");
      -- Set pass count
      Data.Pass_Count := 3;
      ...
      for Pass in 1..3 loop
         ...
         while ULONGLONG(Data.Buf_Index) < Data.Buf_Count loop
            Data.HMG_IS5_Ext_Clear_Main(Drv_List);
            Data.Buf_Index:=Data.Buf_Index+1;
         end loop;
         -- Clean rest bytes
         Data.HMG_IS5_Ext_Clear_Rest(Drv_List);
      end loop;
   end HMG_IS5_Ext_Proc;
