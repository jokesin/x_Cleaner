...
package body Callbacks is
   ...
   is
      ...
      Font      : Font_Type;
   begin
      Create_As_Dialog(Dialog,"About x_Cleaner v 1.2.1 & license",Width => 400,Height => 280);
      Font.Create_Stock_Font(Default_GUI);
      List_Box.Create(Dialog,10,10,380,230,Sort => False,Is_Dynamic => True);
      List_Box.Set_Font(Font);
      List_Box.Add("x_Cleaner v 1.2.1 erases all data from selected volume with special algorithm");
      List_Box.Add("");
